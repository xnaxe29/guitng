...
def update(val):
	...
	plot_main(ax, data_x[mv][axis_to_use], data_y[mv][axis_to_use], data_real[mv][str_for_param_selection], plot_type=colorbar_scaling)
	im2, circle_final = extra_plotting(ax, mv)
...
def ani_frame():
	...
	im_new = plot_main_movie(ax_new, data_x[mv_new][axis_to_use], data_y[mv_new][axis_to_use], data_real[mv_new][str_for_param_selection], plot_type=colorbar_scaling)
